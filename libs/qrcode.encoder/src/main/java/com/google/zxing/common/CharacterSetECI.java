...
/**
 * Encapsulates a Character Set ECI, according to "Extended Channel Interpretations" 5.3.1.1 of ISO
 * 18004.
 *
 * @author Sean Owen
 */
public enum CharacterSetECI {
   ...
   * @return CharacterSetECI representing ECI for character encoding, or null if it is legal but
   * unsupported
   */
