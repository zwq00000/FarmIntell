...
public final class HighLevelEncoder {
  ...
  /**
   * Performs message encoding of a DataMatrix message using the algorithm described in annex P of
   ...
   *                SymbolShapeHint.FORCE_SQUARE} or {@code SymbolShapeHint.FORCE_RECTANGLE}.
