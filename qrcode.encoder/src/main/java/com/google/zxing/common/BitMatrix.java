...
/**
 * <p>Represents a 2D matrix of bits. In function arguments below, and throughout the common module,
 * x is the column position, and y is the row position. The ordering is always x, y. The origin is
 * at the top-left.</p>
 *
...
public final class BitMatrix implements Cloneable {
  ...
  public static BitMatrix parse(String stringRepresentation, String setString, String unsetString) {
    ...
    while (pos < stringRepresentation.length()) {
      if (stringRepresentation.charAt(pos) == '\n' ||
        ...
        bits[bitsPos] = true;
        bitsPos++;
      } else if (stringRepresentation.substring(pos, pos + unsetString.length())
          .equals(unsetString)) {
   ...
   * @return The resulting BitArray - this reference should always be used even when passing your
   * own row
   */
   ...
   *
   * @return {@code left,top,width,height} enclosing rectangle of all 1 bits, or null if it is all
   * white
   */
