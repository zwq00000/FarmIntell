...
public final class Encoder {
   ...
   * @throws WriterException if encoding can't succeed, because of for example invalid content or
   *                         configuration
   */
  ...
  /**
   * @return the code point of the table used in alphanumeric mode or -1 if there is no
  ...
  /**
   * Choose the best mode by examining the content. Note that 'encoding' is used as a hint; if it is
   * Shift_JIS, and the input is only double-byte Kanji, then we return {@link Mode#KANJI}.
   */
  ...
  /**
   * Get number of data bytes and number of error correction bytes for block id "blockID". Store the
   * result in "numDataBytesInBlock", and "numECBytesInBlock". See table 12 in 8.5.1 of
   * JISX0510:2004 (p.30)
   */
